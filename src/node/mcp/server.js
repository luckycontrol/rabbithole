...
const server = new McpServer(
  { name: "rabbithole", version: "0.1.0" },
  {
    instructions: [
      ...
      "A convert_request means the human clicked Convert to document. Read pages[].image_path in order,",
      ...
      "When a branch_request includes region.image_path, read that image before answering and trust it",
