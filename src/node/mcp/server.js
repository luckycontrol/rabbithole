...
const server = new McpServer(
  { name: "rabbithole", version: "0.1.0" },
  {
    instructions: [
      ...
      "   For local PDFs, call ingest_pdf first, author markdown yourself with asset:page-001.png",
      "   references, then pass the returned ingest_id to open_rabbithole. Prefer arXiv HTML",
      "   plus base_url over PDF ingestion when an arXiv HTML version is available.",
