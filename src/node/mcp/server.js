...
const server = new McpServer(
  { name: "rabbithole", version: "0.1.0" },
  {
    instructions: [
      ...
      "A revision_request means the human asked AI to change the current card instead of creating a branch.",
      "Without a 'selection' field, use current_title/current_markdown plus instruction and stream the complete",
      "replacement card through answer_branch. With one, the human highlighted a passage: stream back ONLY the",
      "replacement Markdown for selection.region_markdown — no title line, no fence around it, no commentary, and",
      "none of the surrounding card. current_markdown is context; the host splices your reply into that exact span.",
      ...
      "One with a 'chat_context' field is one turn of an ongoing reader-chat conversation about a page: it",
      "carries that page's full markdown (context_title/context_markdown) plus prior_turns (chronological",
      "question/answer pairs already asked). Answer as a continuation of that conversation, not a fresh ask.",
